...
本解法参考[http://c2.com/cgi-bin/wiki?EightQueensInManyProgrammingLanguages](http://c2.com/cgi-bin/wiki?EightQueensInManyProgrammingLanguages)。
...
###应用foldM的解法
关于`foldM`，官方网站（[http://www.haskell.org/hoogle/?hoogle=foldM](http://www.haskell.org/hoogle/?hoogle=foldM)）给出了这样的解释：
...
而根据[http://www.cs.ut.ee/~varmo/FP2007/slides/loeng13.pdf](http://www.cs.ut.ee/~varmo/FP2007/slides/loeng13.pdf)上给出的定义
